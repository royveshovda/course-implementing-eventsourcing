...
export default function PrototypePage() {
    ...
    useEffect(() => {
        let subscription =
            subscribeStream<PriceChangedEvent>(Streams.Price, (expectedVersion:bigint, events:PriceChangedEvent[])=>{
    ...
    useEffect(() => {
        let subscription =
            subscribeStream<CartEvents>(Streams.Cart, (expectedVersion:bigint, events:CartEvents[])=>{
